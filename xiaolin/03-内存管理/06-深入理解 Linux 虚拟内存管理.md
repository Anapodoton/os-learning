...
![本文概要.png](https://cdn.xiaolincoding.com//mysql/other/1ff04f9ea15582324af7849f3c5f9dab.png)

## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_1-到底什么是虚拟内存地址)1. 到底什么是虚拟内存地址
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/9ddcf37b6c78ffa2087722cdf6fbbc71.png)
...
![img](https://cdn.xiaolincoding.com/gh/xiaolincoder/%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/%E8%99%9A%E6%8B%9F%E5%86%85%E5%AD%98/%E5%9C%B0%E5%9B%BE.png)
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/7be417ea2a4c46466ff35f2bfeb741a1.png)
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/b184e33db8c42f78c5cebe10160092c1.png)

> 进程虚拟内存空间中的每一个字节都有与其对应的虚拟内存地址，一个虚拟内存地址表示进程虚拟内存空间中的一个特定的字节。

## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_2-为什么要使用虚拟地址访问内存)2. 为什么要使用虚拟地址访问内存
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/7c83870f82f56d3e898ce94f93776a76.png)
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_3-进程虚拟内存空间)3. 进程虚拟内存空间
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_4-linux-进程虚拟内存空间)4. Linux 进程虚拟内存空间

在上小节中我们介绍了进程虚拟内存空间中各个内存区域的一个大概分布，在此基础之上，本小节我就带大家分别从 32 位 和 64 位机器上看下在 Linux 系统中进程虚拟内存空间的真实分布情况。

### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_4-1-32-位机器上进程虚拟内存空间分布)4.1 32 位机器上进程虚拟内存空间分布
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/fb9c102ac7a424b0aa1b8ba3a3bbbd54.png)

### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_4-2-64-位机器上进程虚拟内存空间分布)4.2 64 位机器上进程虚拟内存空间分布
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-进程虚拟内存空间的管理)5. 进程虚拟内存空间的管理
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-1-内核如何划分用户态和内核态虚拟内存空间)5.1 内核如何划分用户态和内核态虚拟内存空间

通过 《3. 进程虚拟内存空间》小节的介绍我们知道，进程的虚拟内存空间分为两个部分：一部分是用户态虚拟内存空间，另一部分是内核态虚拟内存空间。

![image.png](https://cdn.xiaolincoding.com//mysql/other/b1402bf81de260b86ce0cb4c19cd4330-20230309233807994.png)
...
![32位地址空间.png](https://cdn.xiaolincoding.com//mysql/other/ffb6e1727e2289f142f6a2a6291cd68c-20230309233812714.png)
...
![/arch/arm/Kconfig.png](https://cdn.xiaolincoding.com//mysql/other/445cb4fb8bfeff15d6350b278f370919.png)
...
![64位地址空间.png](https://cdn.xiaolincoding.com//mysql/other/532e6cdf4899588f8b873b6435cba2d8-20230309233823236.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-2-内核如何布局进程虚拟内存空间)5.2 内核如何布局进程虚拟内存空间
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/8e6efc5f2c39a39959c337077359a824.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-3-内核如何管理虚拟内存区域)5.3 内核如何管理虚拟内存区域

在上小节的介绍中，我们知道内核是通过一个 mm_struct 结构的内存描述符来表示进程的虚拟内存空间的，并通过 task_size 域来划分用户态虚拟内存空间和内核态虚拟内存空间。

![image.png](https://cdn.xiaolincoding.com//mysql/other/b1402bf81de260b86ce0cb4c19cd4330-20230309233844567.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-4-定义虚拟内存区域的访问权限和行为规范)5.4 定义虚拟内存区域的访问权限和行为规范
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-5-关联内存映射中的映射关系)5.5 关联内存映射中的映射关系
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-6-针对虚拟内存区域的相关操作)5.6 针对虚拟内存区域的相关操作
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/aa5c53db83c9a49362dda5a006d2849b.png)
...
![系统IO调用结构.png](https://cdn.xiaolincoding.com//mysql/other/ce6e73b9fdee82cf39f364975aa14ad5.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_5-7-虚拟内存区域在内核中是如何被组织的)5.7 虚拟内存区域在内核中是如何被组织的
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/b1402bf81de260b86ce0cb4c19cd4330-20230309233949162.png)
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_6-程序编译后的二进制文件如何映射到虚拟内存空间中)6. 程序编译后的二进制文件如何映射到虚拟内存空间中
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/2b2dbb2b6ea19871152a3bf6566df205-20230309234013690.png)
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-内核虚拟内存空间)7. 内核虚拟内存空间
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-32-位体系内核虚拟内存空间布局)7.1 32 位体系内核虚拟内存空间布局
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/82d9552d0a8e772f45058d300dcf893a.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-1-直接映射区)7.1.1 直接映射区
...
![image.png](https://cdn.xiaolincoding.com//mysql/other/d945d22667c4ea56dbd2f19677306a91-20230309234037651.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-2-zone-highmem-高端内存)7.1.2 ZONE_HIGHMEM 高端内存
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-3-vmalloc-动态映射区)7.1.3 vmalloc 动态映射区
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-4-永久映射区)7.1.4 永久映射区
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-1-5-固定映射区)8.1.5 固定映射区
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-6-临时映射区)7.1.6 临时映射区
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-1-7-32位体系结构下-linux-虚拟内存空间整体布局)7.1.7 32位体系结构下 Linux 虚拟内存空间整体布局
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-2-64-位体系内核虚拟内存空间布局)7.2 64 位体系内核虚拟内存空间布局
...
![64位地址空间.png](https://cdn.xiaolincoding.com//mysql/other/532e6cdf4899588f8b873b6435cba2d8-20230309234146081.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_7-2-1-64位体系结构下-linux-虚拟内存空间整体布局)7.2.1 64位体系结构下 Linux 虚拟内存空间整体布局
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-到底什么是物理内存地址)8. 到底什么是物理内存地址
...
![内存结构.png](https://cdn.xiaolincoding.com//mysql/other/9651fbd7b5a3b397f7a81acfcd49723c.png)
...
![DRAM结构.png](https://cdn.xiaolincoding.com//mysql/other/27a06c2b3f831d24e57c40b839bfc9e2.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-1-dram-芯片的访问)8.1 DRAM 芯片的访问

我们现在就以读取上图中坐标地址为（2，2）的 supercell 为例，来说明访问 DRAM 芯片的过程。

![DRAM芯片访问.png](https://cdn.xiaolincoding.com//mysql/other/fefc8d348414d2cd0ec09fdfa20daf9c.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-2-cpu-如何读写主存)8.2 CPU 如何读写主存

前边我们介绍了内存的物理结构，以及如何访问内存中的 DRAM 芯片获取 supercell 中存储的数据（一个字节）。本小节我们来介绍下 CPU 是如何访问内存的：

![CPU与内存之间的总线结构.png](https://cdn.xiaolincoding.com//mysql/other/efa862811f305ab0aa15c0422d8933e8.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-3-cpu-从内存读取数据过程)8.3 CPU 从内存读取数据过程
...
![CPU读取内存.png](https://cdn.xiaolincoding.com//mysql/other/b4c3dc16dbfab2682d46772b787ae962.png)
...
### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-4-如何根据物理内存地址从主存中读取数据)8.4 如何根据物理内存地址从主存中读取数据

前边介绍到，当主存中的存储控制器感受到了存储总线上的地址信号时，会将内存地址从存储总线上读取出来。

随后会通过内存地址定位到具体的存储器模块。还记得内存结构中的存储器模块吗 ？

![内存结构.png](https://cdn.xiaolincoding.com//mysql/other/b8c4e85c0bff05f7b26a42c246eec222.png)

而每个存储器模块中包含了 8 个 DRAM 芯片，编号从 0 - 7 。

![存储器模块.png](https://cdn.xiaolincoding.com//mysql/other/1033fbb5b8e2d30c0271b2ad10ead27e.png)
...
![DRAM芯片访问.png](https://cdn.xiaolincoding.com//mysql/other/9b841647ee906862636d257ce7064487.png)
...
![读取存储器模块数据.png](https://cdn.xiaolincoding.com//mysql/other/78f3571fcb65ba401737e27d1fde89b9.png)

由于存储器模块中这种由 8 个 DRAM 芯片组成的物理存储结构的限制，内存读取数据只能是按照物理内存地址，8 个字节 8 个字节地顺序读取数据。所以说内存一次读取和写入的单位是 8 个字节。

![内存IO单位.png](https://cdn.xiaolincoding.com//mysql/other/92c51229fbf868919e06d4426cada701.png)

而且在程序员眼里连续的物理内存地址实际上在物理上是不连续的。因为这连续的 8 个字节其实是存储于不同的 DRAM 芯片上的。每个 DRAM 芯片存储一个字节（supercell）

### [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#_8-5-cpu-向内存写入数据过程)8.5 CPU 向内存写入数据过程
...
## [#](https://xiaolincoding.com/os/3_memory/linux_mem.html#总结)总结
