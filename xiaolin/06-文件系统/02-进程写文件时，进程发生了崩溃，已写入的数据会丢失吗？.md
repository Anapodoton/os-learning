...
![img](https://cdn.xiaolincoding.com//mysql/other/23eb7000c28fb8135e0947620a75d946.png)
...
## [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-cache)Page Cache

### [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-cache-是什么)Page Cache 是什么？
...
### [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#如何查看系统的-page-cache)如何查看系统的 Page Cache？
...
### [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-与-page-cache)page 与 Page Cache
...
### [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#swap-与缺页中断)Swap 与缺页中断
...
### [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-cache-与-buffer-cache)Page Cache 与 buffer cache
...
![图片](https://cdn.xiaolincoding.com//mysql/other/c81ffa0b7d11506ffad3c33001385444.png)

Page Cache 中的每个文件都是一棵基数树（radix tree，本质上是多叉搜索树），树的每个节点都是一个页。根据文件内的偏移量就可以快速定位到所在的页，如下图所示。关于基数树的原理可以参见英文维基，这里就不细说了。

![图片](https://cdn.xiaolincoding.com//mysql/other/cfda154558181c4af27a34c1d4a97552.png)

### [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-cache-与预读)Page Cache 与预读
...
![img](https://cdn.xiaolincoding.com//mysql/other/ae8252378169c8c14b8b9907983f7d8b-20230309235145646.png)

上图中，应用程序利用 read 系统调动读取 4KB 数据，实际上内核使用 readahead 机制完成了 16KB 数据的读取。

## [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-cache-与文件持久化的一致性-可靠性)Page Cache 与文件持久化的一致性&可靠性
...
## [#](https://xiaolincoding.com/os/6_file_system/pagecache.html#page-cache-的优劣势)Page Cache 的优劣势
...
- [Linux内核技术实战课(opens new window)](https://time.geekbang.org/column/intro/337)
- [Reconsidering swapping(opens new window)](https://lwn.net/Articles/690079/)
- [访问局部性(opens new window)](https://zh.wikipedia.org/wiki/访问局部性)
