...
## [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#cpu-如何读写数据的)CPU 如何读写数据的？
...
### [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#分析伪共享的问题)分析伪共享的问题
...
### [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#避免伪共享的方法)避免伪共享的方法
...
## [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#cpu-如何选择线程的)CPU 如何选择线程的？
...
### [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#调度类)调度类
...
### [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#完全公平调度)完全公平调度
...
### [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#cpu-运行队列)CPU 运行队列
...
### [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#调整优先级)调整优先级
...
## [#](https://xiaolincoding.com/os/1_hardware/how_cpu_deal_task.html#总结)总结
